...
class SimpleFoodDatabase {
  ...
  Future<void> _loadFoodData() async {
    ...
    _cachedFoods.addAll([
      Food(
        ...
        nutritionFacts: {'protein': 28.0, 'carbs': 12.0, 'fat': 18.0, 'fiber': 3.0},
      ),
      ...
      Food(
        ...
        nutritionFacts: {'protein': 15.0, 'carbs': 8.0, 'fat': 12.0, 'fiber': 2.0},
      ),
      ...
      Food(
        ...
        nutritionFacts: {'protein': 20.0, 'carbs': 8.0, 'fat': 32.0, 'fiber': 2.0},
      ),
      ...
      Food(
        ...
        nutritionFacts: {'protein': 28.0, 'carbs': 2.0, 'fat': 12.0, 'fiber': 0.0},
      ),
      ...
      Food(
        ...
        nutritionFacts: {'protein': 8.0, 'carbs': 2.0, 'fat': 9.0, 'fiber': 0.0},
      ),
      ...
      Food(
        ...
        nutritionFacts: {'protein': 25.0, 'carbs': 5.0, 'fat': 15.0, 'fiber': 1.0},
      ),
      ...
      Food(
        ...
        nutritionFacts: {'protein': 22.0, 'carbs': 15.0, 'fat': 35.0, 'fiber': 1.0},
      ),
      ...
      Food(
        ...
        nutritionFacts: {'protein': 25.0, 'carbs': 28.0, 'fat': 20.0, 'fiber': 2.0},
      ),
      ...
      Food(
        ...
        nutritionFacts: {'protein': 8.0, 'carbs': 10.0, 'fat': 8.0, 'fiber': 2.0},
      ),
      ...
      Food(
        ...
        nutritionFacts: {'protein': 2.0, 'carbs': 18.0, 'fat': 2.0, 'fiber': 3.0},
      ),
      ...
      Food(
        ...
        nutritionFacts: {'protein': 12.0, 'carbs': 45.0, 'fat': 8.0, 'fiber': 1.0},
      ),
      ...
      Food(
        ...
        nutritionFacts: {'protein': 18.0, 'carbs': 45.0, 'fat': 12.0, 'fiber': 4.0},
      ),
      ...
      Food(
        ...
        nutritionFacts: {'protein': 35.0, 'carbs': 20.0, 'fat': 28.0, 'fiber': 3.0},
      ),
      ...
      Food(
        ...
        nutritionFacts: {'protein': 12.0, 'carbs': 25.0, 'fat': 8.0, 'fiber': 2.0},
      ),
      ...
      Food(
        ...
        nutritionFacts: {'protein': 15.0, 'carbs': 20.0, 'fat': 12.0, 'fiber': 2.0},
      ),
    ]);
  ...
  Future<List<Food>> getRecommendations({
    ...
    if (tastes != null && tastes.isNotEmpty) {
      results = results
          .where((food) => (food.tasteAttributes ?? []).any((taste) => tastes.contains(taste)))
          .toList();
    }
