...
class SecureHttpClient {
  ...
  Future<void> _onRequest(RequestOptions options, RequestInterceptorHandler handler) async {
    try {
      ...
      SecureLogger.error('Request interceptor error',
  ...
  Future<void> _onResponse(Response response, ResponseInterceptorHandler handler) async {
    try {
      ...
      SecureLogger.error('Response interceptor error',
          error: e is Exception ? e : Exception(e.toString()));
      handler.next(response);
    }
  }
  ...
  Future<void> _onError(DioException error, ErrorInterceptorHandler handler) async {
    try {
      ...
      SecureLogger.error('Error interceptor error',
          error: e is Exception ? e : Exception(e.toString()));
      handler.next(error);
    }
  }
  ...
  bool _validateResponseSignature(Response response, String signature) {
    try {
      ...
      SecureLogger.error('Response signature validation error',
          error: e is Exception ? e : Exception(e.toString()));
      return false;
    }
  }
  ...
  bool _isSensitiveParam(String param) {
    ...
    return sensitiveParams.any((sensitive) => param.toLowerCase().contains(sensitive));
  }
