...
class ColdStartQuestionnairePage extends StatefulWidget {
  ...
  @override
  State<ColdStartQuestionnairePage> createState() => _ColdStartQuestionnairePageState();
}

class _ColdStartQuestionnairePageState extends State<ColdStartQuestionnairePage> {
  ...
  Future<void> _handleComplete() async {
    ...
    try {
      ...
      await prefs.setString('cold_start_questionnaire_data', questionnaireData.toJsonString());
  ...
  Widget _buildBottomButtons() {
    final isLastPage = _currentPage == QuestionnaireQuestions.totalQuestions - 1;
    ...
    return Container(
      ...
      child: Column(
        children: [
          // 多选时显示的"下一步"按钮
          if (!isLastPage && QuestionnaireQuestions.questions[_currentPage].isMultiSelect)
            SizedBox(
