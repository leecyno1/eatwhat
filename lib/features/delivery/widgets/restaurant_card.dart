...
class RestaurantCard extends StatelessWidget {
  ...
  /// 获取平台颜色
  Color _getPlatformColor(RestaurantPlatform platform) {
    switch (platform) {
      case RestaurantPlatform.meituan:
        return Colors.yellow[700]!;
      case RestaurantPlatform.eleme:
        return Colors.blue[700]!;
      case RestaurantPlatform.unknown:
