...
class ColdStartQuestionnaireData {
  ...
  factory ColdStartQuestionnaireData.empty() {
    return ColdStartQuestionnaireData(
        answers: [], completedAt: DateTime.now(), skipped: true);
  }
...
class QuestionnaireQuestions {
  static const List<QuestionnaireQuestion> questions = [
    ...
    QuestionnaireQuestion(
      id: 6,
      title: '你希望多久吃上？',
      subtitle: '控制做饭和点单的时间成本',
      options: ['15 分钟内', '20 分钟内', '30 分钟内', '不着急'],
    ),
    QuestionnaireQuestion(
      id: 7,
      title: '这顿预算大概多少？',
      subtitle: '帮助我们避开不合适的价格区间',
      options: ['30 元内', '30-60 元', '60-100 元', '想吃好一点'],
    ),
    QuestionnaireQuestion(
      id: 8,
      title: '此刻更像哪种心情？',
      subtitle: '让推荐更贴近当下状态',
      options: ['想吃热乎', '想清爽点', '想解压', '想冒险'],
    ),
  ];
